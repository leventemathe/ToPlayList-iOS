...
protocol Gradiented {
    ...
    func addGradient(fromColor: CGColor, midColor: CGColor, toColor: CGColor) -> CAGradientLayer
    func addGradient(fromColor: CGColor, midColors: [CGColor], toColor: CGColor) -> CAGradientLayer
}
